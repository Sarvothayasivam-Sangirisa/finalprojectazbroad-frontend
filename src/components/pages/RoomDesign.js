  ...
  const handleCustomFurnitureUpload = async (e) => {
    ...
    try {
      ...
      const response = await axios.post(
        ...
        {
          headers: {
            'X-Api-Key': 'D9446RwnZM322jpqqPjzT5cT', // Replace with your API key
          },
          responseType: 'blob',
        }
      );
      ...
      await addFurnitureIcon(imgURL); // Add the custom furniture to the canvas
    } catch (error) {
